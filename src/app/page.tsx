      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <GlowingCard className="relative overflow-hidden">
          ...
          <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-semibold tracking-tight text-muted-foreground">Followers</CardTitle>
            ...
            <div className="flex items-center gap-2 mt-2">
              <div className="h-1 flex-1 bg-muted rounded-full overflow-hidden">
                <div 
                  ...
                  style={{ width: `${Math.min((mutualFollowers.length / followers.length) * 100, 100)}%` }}
                />
              </div>
        ...
        <GlowingCard className="relative overflow-hidden">
          ...
          <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-semibold tracking-tight text-muted-foreground">Following</CardTitle>
            ...
            <div className="flex items-center gap-2 mt-2">
              <div className="h-1 flex-1 bg-muted rounded-full overflow-hidden">
                <div 
                  ...
                  style={{ width: `${Math.min((mutualFollowers.length / following.length) * 100, 100)}%` }}
                />
              </div>
              <p className="text-xs font-medium text-muted-foreground whitespace-nowrap">
        ...
        <GlowingCard className="relative overflow-hidden">
          ...
          <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-semibold tracking-tight text-muted-foreground">Connections</CardTitle>
        ...
        <GlowingCard className="relative overflow-hidden">
          ...
          <CardHeader className="relative flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-semibold tracking-tight text-muted-foreground">Engagement</CardTitle>
